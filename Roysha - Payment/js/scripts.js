(function($) {
    ...
    tB
        .add('f1')
        .to('.animg1, .ani4img1', 3,{ rotation: '20', ease: Power2.easeNone},'f1')
        .to('.animg2, .ani4img2', 3,{ rotation: '-20', ease: Power2.easeNone},'f1')
        .to('.rcvMobile', .7,{ y: '30', ease:Linear.easeNones},'f1')
        .to('.rcvMobile', .7,{ y: '0', ease:Linear.easeNones}, '-=.5');

        var tC = new TimelineMax({});
        tC
            .add('f2')
            .to('.ani5img2, .ani7img1', 10,{ rotation: '360', ease: Linear.easeNone, repeat: -1},'f2')
            .to('.ani5img3, .ani7img2', 15,{ rotation: '360', ease: Linear.easeNone, repeat: -1},'f2')
            .to('.ani5img4, .ani7img3', 20,{ rotation: '360', ease: Linear.easeNone, repeat: -1},'f2')
            .to('.ani7img4', 5,{ rotation: '360', ease: Linear.easeNone, repeat: -1},'f2')
